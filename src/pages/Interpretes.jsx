 ...
 *
 * It renders a grid of interpreters, each wrapped in a Link to their detail page.
 * Each interpreter is shown using the List component, displaying their name, photo, and biography.
 * If the movie's rating is 10, the interpreter is highlighted.
 *
 * @component
 * @returns {JSX.Element} The rendered interpreters list UI.
 */
